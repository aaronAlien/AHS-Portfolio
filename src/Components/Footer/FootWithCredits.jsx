          ...
          <div className='flex flex-col justify-start gap-6'>
            ...
            <div className='flex items-center justify-start gap-6 w-min mb-2'>
              ...
              >
                ...
                <div className='flex items-center justify-center w-full mx-auto text-sm font-kanit font-light'>
        <p>
            images: <a href="https://adamtitchener.com/" target='blank' className='hover:opacity-50 hover:text-sky-500 transition-all duration-500 ease-in-out'>Adam Titchener</a>
        </p>
    </div>
