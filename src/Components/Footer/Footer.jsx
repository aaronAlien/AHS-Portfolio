      ...
      <div className='flex justify-start gap-6'>
        <div className='flex items-center justify-start gap-6 w-min mb-2'>
          <a
            href='http://'
            target='_blank'
            className='bg-violet-300 text-zinc-950 text-xl rounded-full p-2 border border-transparent hover:opacity-50 hover:bg-sky-500/50 transition-all duration-500 ease-in-out'
          >
            <FiFileText />
          </a>
          <a
